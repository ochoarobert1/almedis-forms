...
<head>
    ...
    <title>Almedis - {title}</title> <!--   The title tag shows in email notifications, like Android 4.4. -->
...
<body width="100%" style="margin: 0; padding: 1rem 0 2rem 0 !important; mso-line-height-rule: exactly; background-color: #e2e2e2;">
            ...
            <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin: auto;  margin-bottom: 4em;">
                ...
                <tr>
                    <td style="padding: 40px 0; text-align: center">
                        <img src="{logo}" width="220" height="81" alt="Almedis" border="0" style="height: auto; font-family: sans-serif; font-size: 15px; line-height: 15px; color: #555555;">
                    </td>
                </tr>
                <!-- Email Header : END -->
                        ...
                        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                            <tr>
                                <td style="padding: 20px; font-family: sans-serif; font-size: 15px; line-height: 20px; color: #555555;">
                                    <h1 style=" text-align: center; margin: 0 0 10px 0; font-size: 25px; line-height: 30px; color: #333333; font-weight: bold;">{title}</h1>
                                    <hr>
                                    {content}
                                </td>
                            </tr>
